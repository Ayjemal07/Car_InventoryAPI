...
#@api.route('/x', methods = ['GET']) #get, put, post, delete (for retrieve, update and delete)
#when logged in, '/contacts/<id>', you need id of the contact you want to update, update or delete.